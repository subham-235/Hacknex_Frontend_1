...
- **Emergency SOS:** microphone recording (maximum 60 seconds), WebM upload (maximum 10 MB), location, contact review, and explicit send confirmation. Supported recording requires Chrome/Edge or another browser with WebM MediaRecorder support. Microphone access requires localhost or HTTPS.
...
1. You record audio and provide a location, then confirm the SOS.
